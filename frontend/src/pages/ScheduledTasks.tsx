    ...
    return (
        <div className="space-y-6">
            <div className="flex justify-between items-center">
                <div>
                    <h1 className="text-2xl font-bold text-slate-900">定时任务管理</h1>
                ...
                <table className="w-full text-left border-collapse">
                    <thead>
                        <tr className="bg-slate-50 border-b border-slate-200 text-xs uppercase text-slate-500 font-semibold tracking-wider">
                            ...
                            <th className="px-6 py-4">时间（Cron）</th>
                    ...
                    <div key={task.id} className="bg-white p-5 rounded-xl shadow-sm border border-slate-200 relative">
                        ...
                        <div className="space-y-2 text-sm border-t border-slate-100 pt-3 mt-3">
                            <div className="flex justify-between">
                                <span className="text-slate-500">上次运行</span>
                    ...
                    <div className="bg-white rounded-2xl p-6 w-full max-w-md shadow-xl border border-slate-100 animate-in fade-in zoom-in duration-200">
                        ...
                        <form onSubmit={handleSubmit} className="space-y-5">
                            <div>
                                ...
                                >
                                    <option value="reserve">预约座位</option>
                                    <option value="signin">蓝牙签到</option>
                                </select>
                            </div>
                            
                            <div>
                                <label className="block text-sm font-medium text-slate-700 mb-1.5">执行时间（每天）</label>
                                <input 
                                    type="time" 
                            ...
                            {type === 'reserve' && (
                                <div className="space-y-5 border-t border-slate-100 pt-5">
                                    <div>
                                        <label className="block text-sm font-medium text-slate-700 mb-2">选座策略</label>
                                        <div className="space-y-3">
                                            <label className="flex items-center space-x-3 cursor-pointer group">
                                                ...
                                                />
                                                <span className="text-slate-700 group-hover:text-indigo-600 transition-colors">尝试所有常用座位（推荐）</span>
                                            </label>
                                            <label className="flex items-center space-x-3 cursor-pointer group">
                                                <input 
                                                    type="radio" 
                                                    ...
                                                    className="w-4 h-4 text-indigo-600 focus:ring-indigo-500 border-gray-300"
                                                />
                                                <span className="text-slate-700 group-hover:text-indigo-600 transition-colors">指定特定座位</span>
                                            </label>
                                        </div>
                                    </div>
